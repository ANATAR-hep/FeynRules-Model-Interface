...
FO$WritePolarizations[out0_,allFieldsInFR_]:=Block[{out=out0,outfile,SubstitutionsPolarization,currentField,currentPolarization,currentFieldString,currentPolarizationString,index,strMomAux},
