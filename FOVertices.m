...
Get["/Users/avasquez/Math_Pack/feynrules-current/Interfaces/UFO/PYIntVertices.m"]
Get["/Users/avasquez/Math_Pack/feynrules-current/Interfaces/UFO/PYIntParticles.m"]
...
FO$WriteVertices[out0_,FeynmanRules0_,opts:options___]:=Block[{out=out0,FeynmanRules=FeynmanRules0,outfile,VRTX,verticesExpressions,InputParameterList,Qi,ParameterValue,Subst,Fermions,CouplingswIm,newCouplings,CouplingList,stringSubstitutions,fieldVertexSubs,exprsVertexSubs},
...
(*  verticesExpressions = FO$GCVertices[FeynmanRules]//.SubstitutionsFRtoForm//.{Complex[a_,b_]:>a+ im b};*)
  ...
  OpenWrite[outfile];
    WriteString[outfile,"*******************************************************************\n"];
    WriteString[outfile,"* File automalically generated by FeynRules -"<>StringTake[wsp,20]<>"*\n"];
  ...
  (* Add "repeat endrepeat" *)

  (* modifyVerticesFile[outfile]; *)
